...
<!-- Header Section Ends -->
<div class="heading" style="background: url(images/table.jpg) no-repeat; color:aliceblue;" width:4000px; >
        <h2>We make your holiday more flexible</h2>
    </div>
